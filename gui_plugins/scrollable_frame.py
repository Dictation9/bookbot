...
class ScrollableFrame(ctk.CTkFrame):
    """
    Usage:
        frame = ScrollableFrame(parent, width=900, height=700, always_show_scrollbar=True)
        frame.pack(fill='both', expand=True)  # or .grid(..., sticky='nsew')
        # Add widgets to frame.inner
    """
    def __init__(self, parent, width=800, height=600, always_show_scrollbar=False, *args, **kwargs):
